...
function loadTemplate() {
    // Python 101 Version 4.0 - IEEE Silver Oak University volunteer frame
    backgroundImage.src = 'python101_volunteer_frame.jpg';
...
function drawCard() {
    ...
    // Fits neatly in blank center area between top logos & "I'M VOLUNTEERING" text
    const frameSize = 440;
    const frameX = (canvas.width - frameSize) / 2;
    const frameY = 340; // moved down to clear top logos, does not overlap text below
